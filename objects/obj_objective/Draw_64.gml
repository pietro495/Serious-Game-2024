...
ds_map_add(description, 65, "Clicca sul punto interrogativo e guarda il tutorial");
...
ds_map_add(description, 950, "Esci dal market e vai a casa");
ds_map_add(description, 951, "Clicca sul computer per controllare le mail");
ds_map_add(description, 955, "Clicca sul computer per controllare le mail");
ds_map_add(description, 960, "Clicca sul letto e vai a dormire");
