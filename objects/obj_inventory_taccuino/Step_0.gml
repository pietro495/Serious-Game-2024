...
if (computed_mouse_x > 640 && computed_mouse_x < 711 &&
    computed_mouse_y > 16 && computed_mouse_y < 88) {
    if (mouse_check_button_pressed(mb_left) && !instance_exists(obj_open_taccuino) && !instance_exists(obj_dialogue_parent) && !instance_exists(obj_overlay)) {
		instance_create_depth(400, center_y, -10000, obj_open_taccuino);
    }
}
