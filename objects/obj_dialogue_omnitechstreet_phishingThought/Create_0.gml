...
dialog.add(global.game_data.dialogueSprite,"Hacker bianchi, neri e grigi… Tre facce della stessa medaglia, tre ombre che si muovono tra le pieghe del codice. ");
