...
draw_text_ext_color(48, center_y - 197, "Grazie dell'aiuto, detective. Può rispondere a questo sondaggio?", lineHeight, textWidth, c_black, c_black, c_black, c_black, image_alpha);
...
if (!instance_exists(obj_button_quiz_next_street)) {
	nextQuestionBtn = instance_create_depth(635, 717, -10050, obj_button_quiz_next_street);
} else {
