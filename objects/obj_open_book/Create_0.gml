...
password2 = "Ricorda: non fornire la tua password a nessuno e non lasciare bigliettini in giro come John Smith :)\nSe pensi che le tue credenziali siano stato rubate, puoi controllare su haveibeenpwned.com, che ti consente di controllare se le tue email o la tua password è stata rubata in un qualche data breach. Se è presente, devi cambiarla il prima possibile.";
