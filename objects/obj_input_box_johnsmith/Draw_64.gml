...
// Disegna la casella
draw_rectangle_color(200, center_y, 600, center_y + 25, c_black, c_black, c_black, c_black, true);
draw_rectangle_color(200, center_y, 600, center_y + 25, c_ltgray, c_ltgray, c_ltgray, c_ltgray, false);

// Disegna il testo inserito
draw_set_color(c_black);
draw_text(200 + 5, center_y + 5, input_text);