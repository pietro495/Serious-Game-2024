...
dialog.add(global.game_data.dialogueSprite,"Tenente, che piacere. Di cosa si tratta?");
dialog.add(spr_dialogue_boss,"Phishing.");
dialog.add(global.game_data.dialogueSprite,"Phishing? Cos'è?");
...
dialog.add(global.game_data.dialogueSprite,"Hai detto che è sparito nel nulla? Qui c'è qualcosa di molto grave sotto...");
...
dialog.add(global.game_data.dialogueSprite,"E poi dicono che il mio lavoro non è stressante.");
...
dialog.add(spr_dialogue_boss,"Premi ALT per evidenziare gli oggetti cliccabili (in verde) o cliccabili ma troppo lontani (in rosso) e cliccali con il tasto sinistro del mouse per interagirvi.\nPremi F11 per andare a schermo intero. \nPremi P per aprire il menù. E ricorda di salvare la partita spesso.");
...
dialog.add(global.game_data.dialogueSprite,"D'accordo. Grazie tenente.");