...
dialog.add(spr_dialogue_detective,"Tenente, che piacere. Di cosa si tratta?");
dialog.add(spr_dialogue_boss,"Phishing.");
dialog.add(spr_dialogue_detective,"Phishing? Cos'è?");
...
dialog.add(spr_dialogue_boss,"Un impiegato della OmniTech. Ha ricevuto un'email, sembrava una comunicazione interna. Ha cliccato. Dopo tre giorni, puff, sparito. La pista ci porta a un posto squallido, un internet café chiamato 'The Black Terminal'. Voglio che inizi da lì.");
