...
dialog.add(spr_dialogue_detective,"Hai detto che è sparito nel nulla? Qui c'è qualcosa di molto grave sotto...");
...
dialog.add(spr_dialogue_detective,"E poi dicono che il mio lavoro non è stressante.");
